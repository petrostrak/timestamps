...
func TestParseStringToTime(t *testing.T) {
	testCases := []struct {
		...
		{"first correct", "20210714T204603Z", "2021-07-14 20:46:03 +0000 UTC", nil},
		{"second correct", "20210715T123456Z", "2021-07-15 12:34:56 +0000 UTC", nil},
	}

	for _, e := range testCases {
		result, err := parseStringToTime(e.invocationPoint)
		if err != nil {
...
func TestGetHourlyTimestamps(t *testing.T) {
	testCases := []struct {
		...
		{"correct", "20060102T150405Z", "20210714T204603Z", "20210715T123456Z", 1, []string{"20210714T210000Z", "20210714T220000Z", "20210714T230000Z", "20210715T000000Z", "20210715T010000Z", "20210715T020000Z", "20210715T030000Z", "20210715T040000Z", "20210715T050000Z", "20210715T060000Z", "20210715T070000Z", "20210715T080000Z", "20210715T090000Z", "20210715T100000Z", "20210715T110000Z", "20210715T120000Z"}},
		{"correct - every 3 hours", "20060102T150405Z", "20210714T204603Z", "20210715T123456Z", 3, []string{"20210714T210000Z", "20210715T000000Z", "20210715T030000Z", "20210715T060000Z", "20210715T090000Z", "20210715T120000Z"}},
		{"wrong invocation points", "20060102T150405Z", "20210715T123456Z", "20210714T204603Z", 1, []string{}},
	}

	for _, e := range testCases {
		ip1, _ := parseStringToTime(e.invocation_p1)
		ip2, _ := parseStringToTime(e.invocation_p2)

		result := getHourlyTimestamps(ip1, ip2, e.frequency)
...
// 		result := getDailyTimestamps(ip1, ip2, e.frequency)
...
func TestGetMonthlyTimestamps(t *testing.T) {
	testCases := []struct {
		...
		{"correct", "20060102T150405Z", "20210214T204603Z", "20211115T123456Z", 1, []string{"20210214T210000Z", "20210314T210000Z", "20210414T210000Z", "20210514T210000Z", "20210614T210000Z", "20210714T210000Z", "20210814T210000Z", "20210914T210000Z", "20211014T210000Z", "20211114T210000Z"}},
		{"correct - every 2 months", "20060102T150405Z", "20210214T204603Z", "20211115T123456Z", 2, []string{"20210214T210000Z", "20210414T210000Z", "20210614T210000Z", "20210814T210000Z", "20211014T210000Z"}},
		{"wrong invocation points", "20060102T150405Z", "20211115T123456Z", "20210214T204603Z", 1, []string{}},
	}
	...
	for _, e := range testCases {
		...
		result := getMonthlyTimestamps(ip1, ip2, e.frequency)
...
func TestGetAnnuallyTimestamps(t *testing.T) {
	testCases := []struct {
		...
		{"correct", "20060102T150405Z", "20180214T204603Z", "20211115T123456Z", 1, []string{"20180214T210000Z", "20190214T210000Z", "20200214T210000Z", "20210214T210000Z"}},
		{"correct - every 2 years", "20060102T150405Z", "20180214T204603Z", "20211115T123456Z", 2, []string{"20180214T210000Z", "20200214T210000Z"}},
		{"wrong invocation points", "20060102T150405Z", "20211115T123456Z", "20180214T204603Z", 1, []string{}},
	}
	...
	for _, e := range testCases {
		...
		result := getAnnuallyTimestamps(ip1, ip2, e.frequency)
